...
//
//  ALL IMAGES AND MUSIC ARE FREE 
//  MOST IMAGES WERE DRAWN
//  LINK TO FREE IMAGE // THE PLAYERS SHIP https://pixabay.com/en/space-ship-space-travel-148536/
//  LINK TO FREE BACKGROUND MUSIC http://freemusicarchive.org/genre/Space-Rock/
//  LINK TO FREE SOUND EFFECTS https://www.freesound.org/people/Robinhood76/packs/6080/
//
//  I HAVE USED A CUSTOM FONT WHICH IS ALSO FREE FOR THE LABELS
//  LINK TO FREE FONT http://www.dafont.com/the-bold-font.font
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    //data type // set up all game states
    enum gameState{
        case preGame // when the game state is before the start of the game
        case inGame // when the game state is durng the game
